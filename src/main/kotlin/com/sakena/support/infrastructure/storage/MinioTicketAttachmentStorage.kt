package com.sakena.support.infrastructure.storage
...
/**
 * Adapter implementing the [TicketAttachmentStorage] port on top of MinIO.
 ...
 */
@Component
class MinioTicketAttachmentStorage(
    ...
    override fun store(
        ...
        val key = "support/${buildingId.value}/${UUID.randomUUID()}${extensionOf(originalFilename)}"
        try {
    ...
    override fun delete(storageKey: String) {
        ...
        runCatching {
            ...
            log.warn("Could not remove ticket attachment '{}': {}", storageKey, it.message)
        }
    }
