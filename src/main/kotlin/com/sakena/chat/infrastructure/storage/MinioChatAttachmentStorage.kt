...
/**
 * Adapter implementing the [ChatAttachmentStorage] port on top of MinIO.
...
class MinioChatAttachmentStorage(
    ...
    override fun store(
        ...
        val key = "chat/${buildingId.value}/${UUID.randomUUID()}${extensionOf(originalFilename)}"
        try {
    ...
    override fun delete(storageKey: String) {
        ...
        runCatching {
            ...
            log.warn("Could not remove chat attachment '{}': {}", storageKey, it.message)
        }
    }
